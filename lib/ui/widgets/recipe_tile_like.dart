...
class RecipeTileLike extends StatefulWidget {
  final RecipeModel data;
  final Function() updateData;
  final List<String> availableIngredients;

  const RecipeTileLike({
    super.key,
    required this.data,
  ...
  @override
  State<RecipeTileLike> createState() => _RecipeTileLikeState();
}

class _RecipeTileLikeState extends State<RecipeTileLike> {
